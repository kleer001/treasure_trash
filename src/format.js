...
import {
  ...
  JUG_EMPTY, SPONGE, CARDBOARD, PANE, TIRE_H, TIRE_V, BICYCLE, RUG, CHAIR,
...
export const LEGEND = [
  ...
  'o tyre lying across the alley — rolls left and right', 'O tyre rolls up and down', 'h office chair on castors',
